section .data
    ...
    caracter db 64           ; almacenar directamente el valor ASCII de '@'

section .bss
    buffer resb 4           ; Reservamos 4 bytes para el buffer
...
_start:
    ;indirecto
    mov al, [caracter]   ; cargar el valor ASCII de '@' desde caracter
